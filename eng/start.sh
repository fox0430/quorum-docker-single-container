...
geth --datadir /qdata/dd --nodiscover --verbosity 6 --raft --raftport 50400 \
  ...
  --ws --wsaddr 0.0.0.0 --wsport 8546 --wsorigins '*' --wsapi personal,admin,db,eth,net,web3,miner,shh,txpool,debug
